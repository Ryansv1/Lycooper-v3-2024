  ...
  */
    ...
    model: {
      ...
      sensorData: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.sensorDataFindRawArgs<ExtArgs>,
            result: Prisma.JsonObject
          }
          aggregateRaw: {
            args: Prisma.sensorDataAggregateRawArgs<ExtArgs>,
            result: Prisma.JsonObject
          }
          count: {
  ...
  export interface sensorDataDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
    ...
    /**
     * Find zero or more SensorData that matches the filter.
     * @param {sensorDataFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const sensorData = await prisma.sensorData.findRaw({
     *   filter: { age: { $gt: 25 } } 
     * })
    **/
    findRaw(
      args?: sensorDataFindRawArgs
    ): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a SensorData.
     * @param {sensorDataAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const sensorData = await prisma.sensorData.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
    ...
    **/
    aggregateRaw(
      args?: sensorDataAggregateRawArgs
    ): Prisma.PrismaPromise<JsonObject>
  ...
  interface sensorDataFieldRefs {
    ...
    readonly sensorId: FieldRef<"sensorData", 'String'>
    readonly sensorData: FieldRef<"sensorData", 'Int'>
   ...
   * sensorData findRaw
   */
  export type sensorDataFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * sensorData aggregateRaw
   */
  export type sensorDataAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type sensorDataWhereInput = {
    ...
    sensorId?: StringFilter<"sensorData"> | string
    sensorData?: IntFilter<"sensorData"> | number
  ...
  export type sensorDataScalarWhereWithAggregatesInput = {
    ...
    sensorId?: StringWithAggregatesFilter<"sensorData"> | string
    sensorData?: IntWithAggregatesFilter<"sensorData"> | number
  ...
  export type sensorDataUpdateInput = {
    ...
    sensorData?: IntFieldUpdateOperationsInput | number
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
  }
