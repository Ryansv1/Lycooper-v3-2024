...
devDependencies:
  ...
  vitest:
    specifier: ^1.2.1
    version: 1.2.1(@types/node@20.11.7)
...
packages:
  ...
  /@prisma/client@5.8.1(prisma@5.10.2):
  ...
  /vite-node@1.2.1(@types/node@20.11.7):
  ...
  /vitest@1.2.1(@types/node@20.11.7):
